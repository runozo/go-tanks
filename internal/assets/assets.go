...
// NewAssets takes a byte slice of a sprite sheet image and a byte slice of json
// data that describes the tiles in the sprite sheet. It returns a pointer to an
// Assets struct containing the sprite sheet image and a map of tile names to
// TileEntries.
